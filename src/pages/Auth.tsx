    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-muted/30 px-4 py-3 text-sm font-medium text-foreground transition-all hover:bg-muted/60 hover:border-primary/40 disabled:opacity-50 mb-6"
        >
